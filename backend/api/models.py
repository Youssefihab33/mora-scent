...
class Category(models.Model):
    ...
    def __str__(self): return self.en
...
class Customer(models.Model):
    ...
    totalSpent = models.DecimalField(max_digits=12, decimal_places=2, default=0)
...
class Coupon(models.Model):
    ...
    minOrderValue = models.DecimalField(max_digits=10, decimal_places=2, default=0)
